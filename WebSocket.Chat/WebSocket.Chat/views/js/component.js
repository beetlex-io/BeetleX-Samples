...
var __header="";
 ...
 __header += '    </div>';
var __footer="";
 __footer += '    <div class="navbar navbar-inverse navbar-fixed-bottom" style="height:30px;background-color:#e4e4e4;border-color:#fff;padding-top:10px;">';
 ...
 __footer += '';
 __footer += '                    <input type="text" v-model="message" class="form-control" style="width:300px;">';
 __footer += '                </div>';
